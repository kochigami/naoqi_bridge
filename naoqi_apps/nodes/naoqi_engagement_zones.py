...
class NaoqiEngagementZones(NaoqiNode):
    def __init__(self):
        ...
        self.movementsInZonesUpdatedPub = rospy.Publisher("movement_in_zone_updated", Bool, queue_size=10)
    ...
    def handleComputeEngagementZoneBasedOnAngularCoordinatesSrv(self, req):
        try:
            ...
            camera_coords = []
            camera_coords[0] = req.linear.x
            camera_coords[1] = req.linear.y
            camera_coords[2] = req.linear.z
            camera_coords[3] = req.angular.x
            camera_coords[4] = req.angular.y
            camera_coords[5] = req.angular.z
    ...
    def handleSetFirstLimitDistanceSrv(self, req):
        ...
        res.success = False
        try:
            res.distance = self.engagementProxy.setFirstLimitDistance(req.distance)
            res.success = True
            return res
        except RuntimeError, e:
            rospy.logerr("Exception caught:\n%s", e)
    ...
    def handleSetLimitAngleSrv(self, req):
        ...
        res.success = False
        try:
            res.angle = self.engagementProxy.setLimitAngle(req.angle)
            res.success = True
            return res
        except RuntimeError, e:
            rospy.logerr("Exception caught:\n%s", e)
    ...
    def handleSetSecondLimitDistanceSrv(self, req):
        ...
        res.success = False
        try:
            res.distance = self.engagementProxy.setSecondLimitDistance(req.distance)
            res.success = True
            return res
        except RuntimeError, e:
            rospy.logerr("Exception caught:\n%s", e)
    ...
    def run(self):
        while self.is_looping():
            try:
                ...
                first_limit_distance_updated_msg = Int64()
                ...
                second_limit_distance_updated_msg = Int64()
                ...
                people_approached_msg = Int64()
                people_approached_msg.data = self.memProxy.getData("EngagementZones/PeopleApproached")
                self.peopleApproachedPub.publish(people_approached_msg)
                ...
                if (len(data_list) > 0):
                    ...
                    self.movementsInZonesUpdated.publish(movements_in_zones_updated_msg)
                ...
                for i in range(len(last_movements_in_zone1_data[1])):
                    ...
                    if last_movements_in_zone1_msg.camera_id == 2:
                        ...
                        last_movements_in_zone1_msg.real_width = last_movements_in_zone1_data[1][i][4][0]
                        last_movements_in_zone1_msg.real_height = last_movements_in_zone1_data[1][i][4][1]
                        last_movements_in_zone1_msg.position_of_associate_point.x = last_movements_in_zone1_data[1][i][5][0]
                        last_movements_in_zone1_msg.position_of_associate_point.y = last_movements_in_zone1_data[1][i][5][1]                    
                    self.lastMovementsInZone1Pub.publish(people_in_zone1_msg)
                ...
                for i in range(len(last_movements_in_zone2_data[1])):
                    ...
                    if last_movements_in_zone2_msg.camera_id == 2:
                        ...
                        last_movements_in_zone2_msg.real_width = last_movements_in_zone2_data[1][i][4][0]
                        last_movements_in_zone2_msg.real_height = last_movements_in_zone2_data[1][i][4][1]
                        last_movements_in_zone2_msg.position_of_associate_point.x = last_movements_in_zone2_data[1][i][5][0]
                        last_movements_in_zone2_msg.position_of_associate_point.y = last_movements_in_zone2_data[1][i][5][1]                    
                    self.lastMovementsInZone2Pub.publish(people_in_zone2_msg)
                ...
                for i in range(len(last_movements_in_zone3_data[1])):
                    ...
                    if last_movements_in_zone3_msg.camera_id == 2:
                        ...
                        last_movements_in_zone3_msg.real_width = last_movements_in_zone3_data[1][i][4][0]
                        last_movements_in_zone3_msg.real_height = last_movements_in_zone3_data[1][i][4][1]
                        last_movements_in_zone3_msg.position_of_associate_point.x = last_movements_in_zone3_data[1][i][5][0]
                        last_movements_in_zone3_msg.position_of_associate_point.y = last_movements_in_zone3_data[1][i][5][1]                    
                    self.lastMovementsInZone3Pub.publish(people_in_zone3_msg)
